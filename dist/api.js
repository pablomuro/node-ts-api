...
var Api = /** @class */ (function () {
    ...
    Api.prototype.middlewares = function () {
        this.express.use(middlewares_1.languageMiddleware);
        this.express.use(body_parser_1.default.json());
        // TODO - Cors options - https://medium.com/@alexishevia/using-cors-in-express-cac7e29b005b
        var origin = (process.env.NODE_ENV == 'production') ? 'https://api-adopet-pablo.herokuapp.com/3000' : 'http://localhost:3000';
        this.express.use(cors_1.default({
            origin: origin
        }));
    };
    Api.prototype.connectDatabase = function () {
